...
from babygemma.nih import NIH_CSV, NIH_DIR, NIH_PHRASE
from babygemma.templates import paraphrases_for, operator_variants_for, n_paraphrases
...
def mimic(rng):
    ...
    from babygemma.data_index import MIMIC_IMG
