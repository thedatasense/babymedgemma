...
OUT = os.path.join(HERE, "hf_export_v2")
...
def main():
    ...
    src = os.path.join(HERE, "modeling_babymedgemma_v2.py")
    import modeling_babymedgemma_v2 as mod
    ...
    from dataset import load_feature_cache, load_pooled_cache
